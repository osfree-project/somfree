...
$(CONFIG_H): $(CONFIG2_SH) $(CONFIG2_C)
	...
	$(CFLAGS) $(CONFIG_CFLAGS) $(STDOPT) $(STDINCL) $(XTLIBS) $(X11LIBS) $(PCSCLIBS) $(UUIDLIBS) $(CFLIBS) $(ATLIBS) $(SSLLIBS) $(CRYPTOLIBS) $(SOCKLIBS) $(STDLIB) $(CONFIG_TAIL)
...
$(CONFIG_HPP): $(CONFIG2_SH) $(CONFIG2_CPP)
	...
	CC="$(CXX)" \
	"$(CONFIG2_SH)" $(CONFIG_HEAD) \
	$(CXXFLAGS) $(CONFIG_CXXFLAGS) $(STDOPTXX) $(STDINCL) $(XTLIBS) $(X11LIBS) $(PCSCLIBS) $(UUIDLIBS) $(CFLIBS) $(ATLIBS) $(SSLLIBS) $(CRYPTOLIBS) $(SOCKLIBS) $(STDLIBXX) $(CONFIG_TAIL)
