...
$(INTDIR)\somdcomm.obj: ..\src\somdcomm.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\somdcomm.c

$(INTDIR)\formarsh.obj: ..\src\formarsh.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\formarsh.c

$(INTDIR)\rhbsomus.obj: ..\src\rhbsomus.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\rhbsomus.c
