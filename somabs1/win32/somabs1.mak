...
$(INTDIR)\somabs1.obj: ..\src\somabs1.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\somabs1.c

$(INTDIR)\omgidobj.obj: ..\src\omgidobj.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\omgidobj.c
