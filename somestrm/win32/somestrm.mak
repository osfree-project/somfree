...
$(INTDIR)\rhbestrm.obj: ..\src\rhbestrm.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\rhbestrm.c

$(INTDIR)\somestio.obj: ..\src\somestio.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\somestio.c

$(INTDIR)\omgestio.obj: ..\src\omgestio.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\src\omgestio.c
